...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const qn=ye("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]);function X2({currentPage:t,onNavigate:e}){const[r,i]=Ye.useState(!1),[n,a]=Ye.useState(!1);Ye.useEffect(()=>{const s=()=>{i(window.scrollY>30)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]);const o=(s,l)=>{a(!1),e(s),s==="home"&&l?setTimeout(()=>{const c=document.getElementById(l);c&&c.scrollIntoView({behavior:"smooth"})},50):window.scrollTo({top:0,behavior:"smooth"})};return f.jsxs("header",{style:{position:"fixed",top:0,left:0,right:0,zIndex:100,padding:r?"10px 16px":"14px 16px",transition:"all 0.3s ease",background:r?"rgba(255, 255, 255, 0.96)":"rgba(255, 255, 255, 0.90)",backdropFilter:"blur(16px)",borderBottom:r?"1px solid rgba(56, 189, 248, 0.3)":"1px solid rgba(56, 189, 248, 0.15)",boxShadow:r?"0 8px 25px rgba(2, 132, 199, 0.08)":"none"},children:[f.jsxs("div",{style:{maxWidth:"1280px",margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"10px"},children:[f.jsxs("div",{onClick:()=>o("home"),style:{cursor:"pointer",display:"flex",alignItems:"center",gap:"10px",minWidth:0},children:[f.jsx("div",{style:{padding:"3px",borderRadius:"10px",background:"#FFFFFF",border:"1px solid rgba(0, 163, 255, 0.3)",boxShadow:"0 4px 12px rgba(0, 163, 255, 0.15)",display:"flex",alignItems:"center",justifyContent:"center",height:"38px",flexShrink:0},children:f.jsx("img",{src:"./logo.png",alt:"Blueidealteck Logo",style:{height:"30px",width:"auto",objectFit:"contain"}})}),f.jsxs("div",{style:{overflow:"hidden"},children:[f.jsxs("div",{style:{fontFamily:"var(--font-heading)",fontWeight:800,fontSize:"clamp(1.05rem, 3.8vw, 1.4rem)",letterSpacing:"-0.5px",color:"#0F172A",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:["BLUEIDEAL",f.jsx("span",{style:{color:"#00A3FF"},children:"TECK"})]}),f.jsx("div",{style:{fontSize:"0.6rem",color:"#0284C7",letterSpacing:"1px",textTransform:"uppercase",fontWeight:700,display:"block"},className:"mobile-subtitle",children:"Software Solutions"})]})]}),f.jsxs("nav",{style:{display:"none",gap:"24px",alignItems:"center"},className:"desktop-nav",children:[f.jsx("button",{onClick:()=>o("home"),className:`nav-btn ${t==="home"?"active":""}`,children:"Home"}),f.jsx("button",{onClick:()=>o("home","about"),className:"nav-btn",children:"About"}),f.jsx("button",{onClick:()=>o("home","services"),className:"nav-btn",children:"Services"}),f.jsx("button",{onClick:()=>o("techstack"),className:`nav-btn ${t==="techstack"?"active":""}`,children:"Tech Stack"}),f.jsx("button",{onClick:()=>o("blog"),className:`nav-btn ${t==="blog"?"active":""}`,children:"Blog"}),f.jsx("button",{onClick:()=>o("home","contact"),className:"nav-btn",children:"Contact"})]}),f.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",flexShrink:0},children:[f.jsxs("button",{onClick:()=>o("home","contact"),className:"glow-btn-primary header-cta-btn",style:{padding:"8px 14px",fontSize:"0.82rem",gap:"6px"},children:[f.jsx("span",{className:"cta-text",children:"Get Started"}),f.jsx(Ji,{size:14})]}),f.jsx("button",{onClick:()=>a(!n),style:{background:"#FFFFFF",border:"1px solid rgba(0, 163, 255, 0.3)",color:"#0284C7",borderRadius:"10px",padding:"6px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 8px rgba(0, 163, 255, 0.1)"},children:n?f.jsx(gh,{size:20}):f.jsx(U2,{size:20})})]})]}),n&&f.jsxs("div",{className:"glass-panel",style:{marginTop:"12px",padding:"20px",display:"flex",flexDirection:"column",gap:"14px",background:"#FFFFFF"},children:[f.jsx("button",{onClick:()=>o("home"),className:"nav-btn-mobile",children:"Home"}),f.jsx("button",{onClick:()=>o("home","about"),className:"nav-btn-mobile",children:"About"}),f.jsx("button",{onClick:()=>o("home","services"),className:"nav-btn-mobile",children:"Services"}),f.jsx("button",{onClick:()=>o("techstack"),className:"nav-btn-mobile",children:"Tech Stack"}),f.jsx("button",{onClick:()=>o("blog"),className:"nav-btn-mobile",children:"Blog"}),f.jsx("button",{onClick:()=>o("home","contact"),className:"nav-btn-mobile",children:"Contact"})]}),f.jsx("style",{children:`
        .nav-btn {
          background: none;
          border: none;
          color: #475569;
