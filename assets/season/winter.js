/* Winter Season Script - Falling Snow Effect */
(function() {
    console.log('❄️ Winter Script Loaded: Initializing Snow...');
    ...
    function createSnowflake() {
        ...
        Object.assign(snowflake.style, {
            ...
            zIndex: zIndex,
            backgroundColor: '#ffffff', // Ensure white color
    ...
    const MAX_SNOWFLAKES = 50; // Slightly increased for visibility
    
    // Start generation
    let snowInterval = setInterval(() => {
        // Stop if theme changes (optional safety)
        if (!document.body.classList.contains('theme-winter')) {
            // clearInterval(snowInterval); // Keep running for now
        }
