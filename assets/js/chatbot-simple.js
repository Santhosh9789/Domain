...
// Careers / Jobs
if(q.includes('career')||q.includes('job')||q.includes('hiring')||q.includes('vacancy')||q.includes('join')||q.includes('work with')){return`Thank you for your interest! 💼

Currently, we do not have any open positions or active hiring campaigns. 

Please check back later or feel free to contact us at <a href="mailto:info@blueidealteck.com">info@blueidealteck.com</a> for future inquiries.`;}
